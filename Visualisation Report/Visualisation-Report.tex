...
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/scatterPlotAllYear.png}}
...
\newpage
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/scatterPlotQuartersNoLabel.png}}
...
\newpage
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/scatterPlotQuartersLabels.png}}
...
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/bubbleChartYearlyRadius.png}}
...
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/bubbleChartYearlyColour.png}}
...
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/bubbleChartQuarterlyRadius.png}}
...
\begin{figure}[!ht]
	\centerline{\includegraphics[scale=0.4]{/mixed/bubbleChartQuarterlyColour.png}}
